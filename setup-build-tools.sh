...
#wget -c http://sourceforge.net/projects/mingw-w64/files/mingw-w64/mingw-w64-release/mingw-w64-v3.1.0.tar.bz2/download
...
#wget -c http://sourceforge.net/projects/installjammer/files/InstallJammer/1.2.15/installjammer-1.2.15.tar.gz/download
